...
public:
    ...
    static std::string HexToStr(const std::string& hex_str);
     ...
     * @return  经过URL编码的字符串
     */
    static std::string UrlComponentEncode(const std::string& str);
    ...
    // static std::string GetFileMd5(const std::string& localFilePath);

    // static std::string GetFileMd5(const char* buffer, size_t buff_len);
